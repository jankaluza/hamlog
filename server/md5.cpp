...
std::string MD5::getHash(const std::string &str) {
	char digest[16];
...
std::string MD5::getHashHEX(const std::string &str) {
	char digest[16];
	char ret[33];
	int i;
	...
	// TODO: wtf those 0x000000FF ?
	for (i=0; i<16; i++) {
		sprintf(ret+i*2, "%02x", digest[i] & 0x000000FF);
	}
	ret[32]=0;
