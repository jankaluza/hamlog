...
Dle platných právních předpisů musí operátoři provozující amatérské bezdrátové vysílání
...
díky možnosti vidět aktuálně vysílající operátory na mapě světa. Je také možné automaticky přeladit radiostanici na správnou
frekvenci, zjištit detailní informace o operátorovi prostřednictvím Internetu nebo například ve staničním deníku
...
Všechny pojmy uvedené v této podkapitole se rovněž ukládají do staničního deníku a tak je jejich vysvětlení nezbytné.
...
příznaky pro NOT NULL, UNIQUE a PRIMARY KEY). %% YARDA (DONE): opět rozvést
\begin{itemize}
...
(pure virtual) metody. Toto demonstruje obrázek \ref{fig:moduly}. %% YARDA: hodil by se odkaz na nějakou knihu o OOP 
