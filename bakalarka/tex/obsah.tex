...
Cílem této práce je seznámit se s oblastí radioamatérkého vysílání a se způsobem vedení staničního deníku,
...
provozních podmínkách amatérské radiokomunikační služby)
%% YARDA2: link na vyhlášku, např. http://aplikace.mvcr.cz/archiv2008/micr/files/205/provadeci_p.pdf 
musí operátoři klubových stanic provozující amatérské vysílání
%% YARDA2: vynechávám 'bezdrátové'  
...
To přináší oproti klasickému papírovému deníku mnoho výhod, usnadňuje to
operátorům práci a šetří čas. Vytvoření spojení i jeho zápis je mnohem
jednodušší, lze např. sledovat aktuální stav a rozložení stanic na mapě světa. Je také možné automaticky přeladit radiostanici na správný
kmitočet, zjištit detailní informace o operátorovi prostřednictvím Internetu nebo například ve staničním deníku
rychle vyhledávat podle nejrůznějších kritérií. V neposlední řadě umožňují elektronické staniční deníky automaticky generovat řadu
statistik.

% dale by to chtelo napsat proc ten denik vubec delame, tedy napsat,
%  ze dle pravnich predpisu (presne zneni lze dohledat na netu nebo dodam) musi operatori
%  vest stanicni denik v papirove nebo elektronicke podobe. A ze kdyz uz ho vedou v elektronicke 
% podobe, tak toho vyuzivaji k usnadneni zivota, jednak pri zapisu spojeni (DX cluster, callbook, mapa 
% sveta, historie spojeni, atp.), jednak k automatickemu sberu statistik a podpore QSL.

%% YARDA (asi DONE, ten uvod mi nejak nejde napsat, mozna to mam ted moc "nasilne" :D
% ): Přidat úvod - rozvinout abstrakt, aby čtenář věděl o čem to bude.
...
správu kmitočtového spektra. %% YARDA2: link na stranky ITU
...
Český telekomunikační úřad (ČTÚ). %% YARDA2: link na ČTÚ
...
držiteli celosvětových rekordů. 

Výše uvedené byl pokus o shrnutí nejrozšířenější činnosti provozovaných
v současné době radioamatéry. Existuje množství dalších činnosti, nicméně jejich
kompletní popis by vyžadoval několikanásobně větší prostor.
...
na obou stanicích, ale musí být také použito stejného druhy provozu. Pro analogové vysílání jsou to například: morse (CW), frekvenční modulace (FM), amplitudová modulace (AM),
amplitudová modulace s potlačeným postraním pásmem (SSB). Digitální druhy provozu jsou například: RTTY, AMTOR, PACTOR, PSK, WSJT, D-Star, P-25, atd.
...
předání těchto údajů používá systém RST. Výměna RST reportu je nezbytným předpokladem platnosti radioamatérského spojení.
...
Jedná se o uzavřenou aplikaci, což brání jejímu dalšímu rozšířovaní širokou veřejností. Oproti aplikaci
...
V této podkapitole je zmíněn seznam případu použití navrhovaného protokolu. Jednotlivé případy použití
