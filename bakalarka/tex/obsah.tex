...
Pøihlá¹ení je provádìno metodou Digest Access Authentication definovanou v RFC 2617. Díky tomu se heslo neposílá
...
Odpovìï serveru vybízí u¾ivatele k pøihlá¹ení podle RFC 2617:
\begin{verbatim}
...
\begin{itemize}
\item \textbf{URI} - URI moduly, na kterém daný modul pracuje. Ka¾dý modul serveru musí mít své jedineèné URI.
...
\chapter{Závìr}
Závìreèná kapitola obsahuje zhodnocení dosa¾ených výsledkù se zvlá¹» vyznaèeným vlastním pøínosem studenta.
 Povinnì se zde objeví i zhodnocení z pohledu dal¹ího vývoje projektu, student uvede námìty vycházející ze zku¹eností 
s øe¹eným projektem a uvede rovnì¾ návaznosti na právì dokonèené projekty.
