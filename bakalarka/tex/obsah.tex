...
V této kapitole je stručně popsána historie amatérského vysílání a jsou zde vysvětleny důležité pojmy používané dále v práci.
...
byla myšlenka našich předků rozhlas %% YARDA (DONE): Asi radio jako mají na ČRK.
...
Echolink \cite{echolink}, %%YARDA: link literatura, na echolink.org,
...
přenosu hlasu, např. D-STAR \cite{dstar}, %% YARDA (DONE): link
P25 C4FM, atp.
